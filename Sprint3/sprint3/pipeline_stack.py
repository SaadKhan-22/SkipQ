...
from sprint3.pipeline_stage import SaadSp3Stage
...
class SaadPipelineStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        synth = pipelines_.ShellStep("CodeBuild", 
                input= source,
                commands = ['cd saad/Sprint3', 
                    'pip install -r requirements.txt',
                    'npm install -g aws-cdk',
                    'cdk synth'],
                primary_output_directory= "saad/Sprint3/cdk.out"
                )
        ...
        beta = SaadSp3Stage(self, 'SKbeta')
        prod = SaadSp3Stage(self, 'SKprod')
